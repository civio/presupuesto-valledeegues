...
DATA_SOURCE_POPULATION = 'https://administracionelectronica.navarra.es/GN.InstitutoEstadistica.Web/informacionestadistica.aspx?R=1&E=1'

# Setup Data Source Inflation link
DATA_SOURCE_INFLATION = 'https://administracionelectronica.navarra.es/GN.InstitutoEstadistica.Web/InformacionEstadistica.aspx?R=1&E=182'

# Setup Main Entity Web Url
MAIN_ENTITY_WEB_URL = 'http://www.valledeegues.com/es/inicio/'

# Setup Main Entity Legal Url (if empty we hide the link)
MAIN_ENTITY_LEGAL_URL = 'http://www.valledeegues.com/es/general/aviso-legal/'
...
OVERVIEW_INCOME_NODES = ['45', '11', '34', '53', '33', '29', '13']

OVERVIEW_EXPENSE_NODES = ['32', '23', '13', '92', '17', '33', '16', '24', '21', '15', '44', '34']
